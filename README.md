This repository contains a Python 3.8 compatible version of the original [generative-ai-python](https://github.com/google-gemini/generative-ai-python).

## Original Repository

The original library can be found [here](https://github.com/google-gemini/generative-ai-python).

## Changes Made

- Fixed incompatibilities with Python 3.8.
